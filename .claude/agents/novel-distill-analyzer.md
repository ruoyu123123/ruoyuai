...
```json
{
  ...
  "qualitative_dims": {
    ...
    "dim12_角色引入":"…", "dim13_信息投放":{"release_sequence":["按出场顺序标信息释放节拍∈{前置全交代,逐步揭露,悬置到揭底,误导后反转}"],"summary":"…"}, "dim14_节奏控制":"…", "dim15_独特标识":"…",
    ...
    "dim32_信息差管理":{"per_point":[{"span":"段N","gap_code":"<reader_adv=读者已知角色不知|reader_disadv=角色已知读者不知|double_blind=都不知>","confidence":"high|low"}],"summary":"…"}, "dim33_情绪节拍图":"X%低开→Y%升级→…", "dim34_叙事距离变化":"…", "dim35_期待感构建":"…",
    ...
    "dim51_张力曲线":[{"pct":10,"tension":"0-10","valence":"+/-","tension_type":"<suspense|curiosity|surprise|none>","span":"<本拍对应原文起句20字内·定位证据>"}],
    "dim52_钩子兑现":[{"位置":"章末/段N","类型":"<高压开头钩/剧情错位钩/对话断句钩/动作未完成钩/新设定钩/情绪高潮钩/留白反转钩>","expectation_type":"<真期待|假期待(故意误导后超越)>","兑现章距":"埋到回收隔几章·未回收填null"}],
    "dim53_推进密度":"<三章一爆/五章一爆/匀速喷设定/前松后紧/慢热>+信息释放节奏描述（呼应『卡剧情非卡字数』）",
    "dim54_叙述伦理":{"narrator_reliability":"<可靠|部分可靠|不可靠>(作者创作选择非穿帮)","anachrony_density":"倒叙/插叙密度(每cluster几处·in_medias_res首块高属正常)","focalization":"<零聚焦全知|内聚焦贴角色|外聚焦只观察>主导型"},
    "_B8_主题意象骨":"dim55 抓作者『象征意象→母题贯穿』(记忆调研·主题/母题/象征追踪)——具体象征意象词(非物理道具非设定)承载抽象母题·冰山写法靠母题贯穿(诡秘五色石/凿窍纪七窍倒计时象征链)。B1_道德滤镜.母题是抽象主题·dim55 给它具体意象词锚点才能跨章追踪复现。",
    "dim55_象征意象":{"recurring_motif_images":["作者反复用的具体象征意象词(非物理道具非设定·带象征义·如:笼中鸟/未合拢的缝/反复的雨)·无则空list"],"motif_to_theme":"<这些意象承载的母题(呼应B1_道德滤镜.母题·如『未合拢的缝』承载『留一线生机』)·无则null>","image_recurrence":"<关键意象跨章复现描述·首次埋设→复现章·估不准给区间·无则null>"}
  },
  ...
  "continuity": {
    ...
    "emotional_arc":"本cluster整体情绪走向", "tension_curve":"紧张度曲线", "ppp_triple":{"promise":"开篇立的承诺(语调/情节/信息/角色4类)","progress":"中段进展手法","payoff":"结尾兑现方式·缺填null"}
  },

  "author_decisions": {
    "_note": "阶段2 作者思维骨·LISA 第一段（自由描述+原文证据·不强行归类·下游 reflect 归一成『作者在X倾向Y』）。这些是『作者在岔路口怎么选』的决策原则·段长抓不到的骨·可选段缺了走 free_notes。",
    "B1_道德滤镜": {"母题":"作者反复回到的母题(如:天才的孤独/规则即暴力/重来仍如此)", "奖惩":"叙事奖励哪种行为·惩罚哪种", "胜利代价":"主角胜利时作者附加什么代价/阴影/反讽(辰东式:欢喜结局藏悲凉)", "叙述者姿态":"对人物是审判/共情/冷眼·对反派给自洽逻辑还是扁平恶"},
    "B2_心理距离": {"默认级":"Gardner 1-5 级作者默认停靠级(1全知远→5意识流近)", "自由间接引语":"是否用(角色思想用叙述者声音写·无引号无标签)·密度", "内心戏密度":"沉浸式高内省(Woolf) vs 外部白描近零内省(海明威)"},
    "B3_留白冰山": {"说透还是留白":"情绪/信息直陈 vs 留白让读者补", "侧写":"关键情感时刻直陈情绪还是用物件/动作侧写·水上几分水下几分"},
    "per_scene_rationale": [{"scene":"段N范围/场景名","decision_type":"<道德滤镜|心理距离|留白冰山|声纹区分|情绪节拍|信息差|钩子布置> 单选枚举","the_what":"作者这一处具体做了什么·贴原文证据(≤30字摘录)","the_why":"作者为什么这么选·1-2句因果(如:此处不直陈悲痛而用『他把碗洗了三遍』侧写·因角色隐忍·直陈破人设)","gap_filled":"相对通用网文/AI默认写法的差(如:AI默认写『他心如刀绞』·作者用动作侧写)"}]
  },

  "characterization": {
    "_note": "阶段2 人物刻画骨·作者『怎么刻画人物』的手法(非『人物有多深』的分布)。",
    "C1_刻画比例": "直接告知性格 vs 让性格从动作/对话/他人反应涌现·大约几比几",
    "C2_声纹三件套": [{"角色":"…","词汇层级":"文白/粗俗/书生气","句子节奏":"短促/绵长/爱反问","情绪底色":"冷/燥/痞/怯"}],
    "C2_配角区分度":"遮住说话人标签·配角vs主角台词能否区分·区分度高低",
    "C3_登场签名": [{"角色":"…","登场beat":"动作/台词/外貌/他人反应定调","标志性签名":"物件/口癖/动作(维托式安静手势=权力)"}]
  },
...
- **dim32 知识差三态（D3·读者-角色信息差）**：每个信息差点先填 `gap_code` 受控值（reader_adv=读者已知角色不知 / reader_disadv=角色已知读者不知 / double_blind=都不知）再写 summary；拿不准的点标 `confidence=low` 不强凑（照 B7 防漂移纪律·绝不为枚举硬套）。这是「信息差流上帝视角 vs 悬疑蒙读者」的硬指纹。
- **B7 节奏序列防漂移**（dim49-53）：先逐场景自由观察「这一拍干了什么」再归类节拍类型，**不为凑枚举硬套**；张力/翻转判断给原文段落位置证据，估不准给区间；钩子兑现间隔数不准则填 null（绝不编造章距）。
- **dim51 张力机制三向度**（Sternberg·读者-文本信息差·「为什么紧张」的骨）：每个张力点的 `tension_type` 三选一照三句填空判——(a) 读者已知有炸弹/危险存在、还没爆、在等它爆 = `suspense`；(b) 结果/异象先抛出、因未知，读者想知道「到底发生了啥/为什么」= `curiosity`；(c) 关键信息被作者 withhold，临到揭晓才反转打脸读者预期 = `surprise`；这一拍没有信息差张力（纯过场/纯情绪起伏）= `none`，判不准就填 `none` **不硬凑**。每点必附 `span`（原文起句 20 字内）作定位证据。`tension` 数值只抓「多紧张」，`tension_type` 抓「为什么紧张」——两者正交。
- **per_scene_rationale（作者决策 rationale 链·D1）**：只填本 cluster 最能体现作者思维的 2-4 处岔路口决策（不求全）；`decision_type` 必从枚举单选；`the_what` 必带原文证据（≤30 字摘录·无证据宁可不填·**绝不编造**）；`the_why` 必须是**因果**不是复述 `the_what`；`gap_filled` 必须给**具体的通用写法对照**（泛泛说「更有文学性」无效）。这是从「作者倾向 Y」到「作者为什么这么决策」的画骨。
